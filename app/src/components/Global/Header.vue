...
<template>
	<header class="relative w-full">
		<div class="bg-white w-full h-full absolute opacity-90"></div>
		<!-- desktop header bg -->

		<!-- desktop nav -->
		<nav class="relative px-4 py-2 flex justify-between items-center">
			<!-- desktop nav -->
			<a
				href="#"
				class="hidden text-3xl font-bold leading-none w-[175px] lg:block"
			>
				<KDLogo />
			</a>

			<a href="#" class="text-3xl font-bold leading-none w-[50px] lg:hidden">
				<KDLogoSmall />
			</a>

			<div class="lg:hidden">
				<button class="navbar-burger flex items-center text-navy p-3">
					<svg
			...
			>
				<li>
					<a
						href="#"
						class="text-lg font-semibold text-navy hover:text-gray-500"
						>Our Experience</a
					>
				</li>
				<li>
		...
		<div class="navbar-menu relative z-50 hidden">
			...
			<nav
				class="fixed top-0 left-0 bottom-0 w-full flex flex-col pt-2 pb-6 px-6 bg-white border-r overflow-y-auto"
			>
